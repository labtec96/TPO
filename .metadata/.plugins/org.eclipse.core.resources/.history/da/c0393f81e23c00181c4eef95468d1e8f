...
public class MainGui extends JFrame
{
	...
	private JLabel lblTlumaczenie_1;

	public MainGui()
	{
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 501, 144);
		...
		lblTlumaczenie = new JLabel("");
		lblTlumaczenie.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblTlumaczenie.setBounds(304, 42, 147, 14);
		contentPane.add(lblTlumaczenie);

		lblTlumaczenie_1 = new JLabel("Tlumaczenie:");
		lblTlumaczenie_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblTlumaczenie_1.setFont(new Font("Tahoma", Font.BOLD, 12));
		lblTlumaczenie_1.setBounds(304, 15, 147, 14);
		contentPane.add(lblTlumaczenie_1);
			...
			public void actionPerformed(ActionEvent arg0)
			{
				...
				try
				{
					...
					else
					{
						...
						(new Thread(new Klient(tfHaslo.getText(), tfKodKraju.getText(), port))).start();
					}
	...
	{
		this.lblTlumaczenie = lblTlumaczenie;
	}
}
